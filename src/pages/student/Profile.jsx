...
const Profile = () => {
    ...
    // fro fill up the name input filed whenever the user click on edit profile page
            ...
            <div className='flex flex-col md:flex-row items-center md:items-start gap-8 my-5'>
                ...
                <div className='flex flex-col items-center'>
                    <Avatar className="h-24 w-24 md:h-32 md:w-32 mb-4">
                        <AvatarImage className="object-cover" src={user?.photoUrl || "https://t3.ftcdn.net/jpg/08/05/28/22/360_F_805282248_LHUxw7t2pnQ7x8lFEsS2IZgK8IGFXePS.jpg"} />
                            ...
                            <div className='grid gap-4 py-4'>
                                ...
                                <div className='grid grid-cols-4 items-center gap-4'>
                                    ...
                                    <Input
                                        ...
                                        type="file"
                                        accept="image/*" className="col-span-3 cursor-pointer" />
                                </div>

                            </div>
                            <DialogFooter>
                                <Button className="w-full" disabled={updateUserIsLoading} onClick={updateUserHandler}>
                                    {
                                        updateUserIsLoading ? (
                                            <>
