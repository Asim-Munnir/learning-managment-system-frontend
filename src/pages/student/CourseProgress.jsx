...
const CourseProgress = () => {
  ...
  if (isError) return <p>Failedd to load course details</p>
  console.log(data)
  ...
  // Handle a specific lecture to watch
  ...
  return (
    <div className='max-w-7xl mx-auto p-4 mt-20'>
      ...
      <div className='flex justify-between mb-4'>
        ...
        <Button className="dark:bg-black" onClick={completed ? handleInCompleteCourse : handleCompleteCourse}
          variant={completed ? "outline" : "default"}
        >
          {
            completed ? <div> <span>Mark As InCompleted</span></div> : "Mark As Completed"
          }
        </Button>
      </div>
        ...
        <div className='flex-1 md:w-3/5 h-fit rounded-lg shadow-lg p-4'>
          <div>
            <video
              ...
              controls
              className='w-full hiauto md:rounded-lg'
