...
const CourseDetail = () => {
    ...
    const { data, isLoading, isSuccess, error } = useGetCourseDetailWithStatusQuery(courseId)


    if (isLoading) return <h1 className='mt-20'>Loading...</h1>
    if (error) return <h1>Error loading course</h1>
    ...
    return (
        <div className='mt-20 space-y-5 dark:bg-[#0F0F0F]'>
            <div className='bg-[#2D2F31] dark:bg-[#000000] text-white'>
            ...
            <div className='max-w-7xl mx-auto my-5 px-4 md:px-8 flex flex-col lg:flex-row justify-between gap-100 space-y-5 md:space-y-0'>
                ...
                <div className='w-full lg:w-1/3'>
                    <Card>
                        ...
                        <CardFooter className="flex justify-center p-4">
                            {
                                purchased ? (
                                    <Button onClick={handleContinueCourse} className="w-full">Countinue Course</Button>
                                ) : (
